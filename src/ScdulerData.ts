...
export class SchedulerData {
  ...
  public getContentCellWidth() {
    const contentCellConfigWidth = this.getContentCellConfigWidth() || 0;
    const schedulerWidth = this.getSchedulerWidth() || 0;
    return this.isContentViewResponsive()
      ? (Number(schedulerWidth) * Number((contentCellConfigWidth || 0).toString().slice(0, -1))) /
          100
      : contentCellConfigWidth;
  }

  public getSchedulerContentDesiredHeight() {
    let height = 0;
  ...
  public isSchedulerResponsive() {
    return (
      typeof this.config.schedulerWidth === 'string' && this.config.schedulerWidth.endsWith('%')
    );
  }
  ...
  private createSlots() {
    ...
    this.slots = this.initializeSlotData(
  ...
  private getSchedulerWidth() {
    ...
    return this.isSchedulerResponsive()
      ? (baseWidth * Number(this.config.schedulerWidth.toString().slice(0, -1))) / 100
